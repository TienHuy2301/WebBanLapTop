    ...
    <div class="col-12 tm-block-col mt-5">
        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
            <div class="row">
                ...
                <span class="tm-block-title col-md-4">Danh Sách Đơn Hàng Thành Công</span>
                                    ...
                                    <td>
                                        <?php
                                                    if ($result['statusId'] == 0) {
                                                        ?>
                                            <div class='tm-status-circle pending'></div><a href='' style='color:#efc54b;'>Chưa Giải Quyết</a>
                                        <?php
                                                    } elseif ($result['statusId'] == 1) {
                                                        ?>
                                            <div class='tm-status-circle moving'></div><a href='' style='color:#9be64d;'>Di Chuyển</a>
                                        <?php
                                                    } elseif ($result['statusId'] == 3) {
                                                        ?>
                                            <span style='color:#b8ff9a;'>Thành Công</span>
                                        <?php } ?>
                                    </td>
