    ...
    <div class="col-12 tm-block-col mt-5">
        <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
            <div class="row">
                ...
                <span class="tm-block-title col-md-4">Danh Sách Đã Hủy</span>
                            ...
                            if ($result['statusId'] == 2) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($result['statusId'] == 2) {
                                        ?>
                                            <a onclick ="return confirm('Bạn Có Muốn giải quyết Đơn Hàng Này Ngay Bây Giờ??')" href='?pendingid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&date=<?php echo $result['date'] ?> &&pending=pending' style='color:#f10700;'>Đã Hủy</a>
                                        <?php } ?>
                                    </td>
