    ...
    public function addnewprof($adminName, $adminUser, $adminEmail, $adminPass, $adminRepass)
    {
        ...
        if (empty($adminName) || empty($adminUser) ||  empty($adminEmail) || empty($adminPass) || empty($adminRepass)) {
            ...
            if ($mail) {
                ...
                if ($result == true) {
                    $alert = '<p class="alert alert-success text-center">Thêm Tài khoản admin thành công</p>';
                    return $alert;
                } else {
                    $alert = '<p class="alert alert-danger text-center">Thêm Tài khoản admin thành công</p>';
                    return $alert;
                }
            }
        }
