...
<div clas="container">
  <div class="row">
    <div class="col-md-7">
      <div>
        <h2 class="tm-block-title">Tài Khoản Admin</h2>
      </div>
    ...
    <div class="col-md-5 mt-5 ">
      <div class="tm-bg-primary-dark tm-block tm-block-settings">
        <div class="row">
          <h2 class="tm-block-title">Thêm Tài Khoản Admin</h2>
        </div>
        <div class="row">
          <?php
        ...
        <form action="accountsList.php" class="tm-signup-form row" method="POST">
          ...
          <div class="col-12">
            <input type="submit" class="btn btn-primary btn-block text-uppercase" value="Thêm Tài Khoản">
          </div>
        </form>
      </div>
    </div>
