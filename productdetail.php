							...
							<div class="add-to-cart">
								<form action="" method="POST">
									...
									<?php if ($result_detail['stock'] == 0) { ?>
										...
										<button type="submit" name="submit" style="" class="btn btn-danger" disabled><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ Hàng</button>

									<?php } else { ?>

										<button type="submit" name="submit" class="add-to-cart-btn btnSend"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ Hàng</button>
