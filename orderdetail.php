                    ...
                    while ($result = $get_product_order->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                        if ($result['statusId'] == 0) {
                                            ?>
                                    <div class='tm-status-circle pending'></div><span style='color:#efc54b;'><b>Chưa Giải Quyết</b></span>
                                <?php
                                        } elseif ($result['statusId'] == 1) {
                                            ?>
                                    <div class='tm-status-circle moving'></div><span style='color:green;'><b>Đang Vẩn Chuyển</b></span>
                                <?php
                                        } elseif ($result['statusId'] == 2) {
                                            ?>
                                    <div class='tm-status-circle cancelled'></div><span style='color:#da534f;'><b>Đã Hủy</b></span>
                                <?php
                                        } elseif ($result['statusId'] == 3) {
                                            ?>
                                    <span style='color:#56f16f;'><b>Thành Công</b></span>
                                <?php
                                        }
                                        ?>
                            ...
                            <td>
                                ...
                                ?>
                                    <a onclick ="return confirm('Bạn đã nhận được hàng phải không??')" class="btn btn-primary" href='?completeid=<?php echo $result['id'] ?>&price=<?php echo $result['price'] ?>&date=<?php echo $result['date']?>&complete=complete'>Đã Nhận Hàng</a>
                                <?php   
                                }else{
                                    echo "N/a";
                                }
